...
class TeamType:
    ...
    SELF_PLAY_DUMMY = 'SPDUM'

    SELF_PLAY_X_TYPES = [SELF_PLAY_LOW, SELF_PLAY_MEDIUM, SELF_PLAY_MIDDLE, SELF_PLAY_HIGH, SELF_PLAY_ADVERSARY, SELF_PLAY_DUMMY]
