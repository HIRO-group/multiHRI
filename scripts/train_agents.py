...
def FCP(args, pop_force_training, fcp_force_training, parallel):
    args.fcp_train_types = [TeamType.RANDOM]
    args.fcp_eval_types = {'generate' : [TeamType.LOW_FIRST, TeamType.HIGH_FIRST, TeamType.MEDIUM_FIRST],
                            'load': []}
...
def set_input(args, quick_test=False):
    ...
    '''
    args.layout_names = ['3_chefs_small_kitchen_two_resources', 
