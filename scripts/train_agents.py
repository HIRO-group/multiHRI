...
def SP_w_SP_Types(args,
                  ...
                  parallel:bool,
                  curriculum_kind:str="standard") -> None:
    '''
    ...
    CURRICULUM_SET = {
        "standard": Curriculum(train_types = args.sp_w_sp_train_types,
                        is_random=False,
        ...
        "inverted": Curriculum(train_types = args.sp_w_sp_train_types,
                        is_random=False,
                        total_steps = args.sp_w_sp_total_training_timesteps//args.epoch_timesteps,
                        training_phases_durations_in_order={
        ...
        "mh_only": Curriculum(train_types = args.sp_w_sp_train_types,
                        is_random=False,
                        total_steps = args.sp_w_sp_total_training_timesteps//args.epoch_timesteps,
                        training_phases_durations_in_order={
                            TeamType.SELF_PLAY_MEDIUM: 0.75,
        ...
        "h_only": Curriculum(train_types = args.sp_w_sp_train_types,
                        is_random=False,
                        total_steps = args.sp_w_sp_total_training_timesteps//args.epoch_timesteps,
                        training_phases_durations_in_order={
                            TeamType.SELF_PLAY_HIGH: 1.0,
                        },
                        rest_of_the_training_probabilities={
                            TeamType.SELF_PLAY_LOW: 0.4,
                            TeamType.SELF_PLAY_MEDIUM: 0.3,
...
if __name__ == '__main__':
    ...
    SP_w_SP_Types(args=args,
                   ...
                   sp_w_sp_force_training=sp_w_sp_force_training,
                   parallel=parallel,
                   curriculum_kind="standard")

    SP_w_SP_Types(args=args,
                   pop_force_training=pop_force_training,
                   sp_w_sp_force_training=sp_w_sp_force_training,
                   parallel=parallel,
                   curriculum_kind="inverted")

    SP_w_SP_Types(args=args,
                    pop_force_training=pop_force_training,
                    sp_w_sp_force_training=sp_w_sp_force_training,
                    parallel=parallel,
                    curriculum_kind="mh_only")
