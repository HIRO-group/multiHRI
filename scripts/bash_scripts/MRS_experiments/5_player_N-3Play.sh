...
ALGO="SPN_XSPCKP"
TEAMMATES_LEN=4
UNSEEN_TEAMMATES_LEN=3
NUM_PLAYERS=$((TEAMMATES_LEN + 1))

HOW_LONG=35
NUM_OF_CKPOINTS=50
LAYOUT_NAMES="dec_5_chefs_counter_circuit,dec_5_chefs_storage_room,dec_5_chefs_secret_heaven,selected_5_chefs_spacious_room_no_counter_space"

EXP_DIR="Complex/$NUM_PLAYERS" # When quick_test=True this will be overwritten to "Test/$EXP_DIR"
TOTAL_EGO_AGENTS=4
QUICK_TEST=false
...
python scripts/train_agents.py \
    ...
    --unseen-teammates-len ${UNSEEN_TEAMMATES_LEN} \