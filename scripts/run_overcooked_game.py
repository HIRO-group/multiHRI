...
if __name__ == "__main__":
    ...
    args.num_players = 3
    args.layout = '3_chefs_4P_4O_4D_3S'
    args.p_idx = 0

    tm1_path = 'agent_models/all-layouts-supporter/fcp_hd256_seed68/best'
    tm2_path = 'agent_models/all-layouts-supporter/fcp_hd256_seed68/best'
